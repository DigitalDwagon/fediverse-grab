...
project = Project(
    title=TRACKER_ID,
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/e/e4/Vbox7_icon.png" height="50px" title=""/>
        <h2>Vbox7 <span class="links"><a href="https://vbox7.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/vbox7/">Leaderboard</a> &middot; <a href="https://wiki.archiveteam.org/index.php/Vbox7">Wiki</a></span></h2>
        <p>Archiving Vbox7.</p>
    '''
)
